...
PlaylistInfo::PlaylistInfo(const QMap<QString, QString> &info) : m_info(new QMap<QString, QString>(info)) {}
...
QMap<QString, QString> PlaylistInfo::defaultInfo() { return QMap<QString, QString>{{"Name", "default"}}; }

Playlist::Playlist() : m_playListInfo(nullptr), m_playContentList(nullptr) {}

Playlist::Playlist(const QMap<QString, QString> &info, PlayContentList *playContentList)
    : m_playListInfo(new PlaylistInfo(info)), m_playContentList(playContentList) {}
...
Playlist::Playlist(const PlaylistInfo &playlistInfo, const PlayContentList &playContentList)
    : m_playListInfo(new PlaylistInfo(playlistInfo)), m_playContentList(new PlayContentList(playContentList)) {}
...
void Playlist::appendContent(PlayContent *playContent) { m_playContentList->append(playContent); }

void Playlist::removeContentAt(const int &index) { m_playContentList->removeAt(index); }
